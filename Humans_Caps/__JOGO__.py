...
def ItemCapivara():
    ...
    os.system('cls')
    print(f"""{BLACK}
  _____________________________________        {WHITE} LIFE: {RED}{personagemVida}{BLACK}
 /                                     \  ════════════════════════════════════════════════╗
...
{RESET}""")
    ...
    if i == "1" and pocaoCura >= 1:
       ...
       |______8______|/
        ...
        os.system('cls')
        print("\nVocê carregou a arma com munição traçante!")
        print(f"""{RED}\n\n
       _,________
      _T _{WHITE}=={RED}____()
     /{WHITE}##{RED}(_)-'  ______
    /{WHITE}##{RED}/      /{WHITE}BALAS{RED}/|
    '''      /__+__/ /
             |_____|/ 
{RESET}""")
